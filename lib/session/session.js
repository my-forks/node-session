 ...
 * @return
 */
Manager.prototype.remove = function(session) {
 ...
 * @return
 */
Session.prototype.unset = function(key, defaultValue) {
	this.read();
 ...
 * Remove me
 * 
 * TODO: check not to remove twice? and block set/set, etc?
 * 
 * @return
 */
Session.prototype.remove = function() {
	if (this.id != undefined) {
		this._manager.getStorage().remove(this);
		this.id = undefined;
	}
	return this;
};
